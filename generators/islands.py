...
island(2, 2)
for x in range(5):
	if random.random() < 0.05: tntisland(random.randint(0, BOARDSIZE[0] - 1), random.randint(0, BOARDSIZE[1] - 1))
	else: island(random.randint(0, BOARDSIZE[0] - 1), random.randint(0, BOARDSIZE[1] - 1))
